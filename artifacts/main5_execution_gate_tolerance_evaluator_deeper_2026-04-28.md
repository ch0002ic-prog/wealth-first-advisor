...
## Validation Coverage By Family
- blind_forward: validation_rows=2
- piecewise: validation_rows=2
- reverse_blind: validation_rows=6
- surrogate: validation_rows=2
...
- required_families: ['surrogate', 'piecewise', 'blind_forward', 'reverse_blind']
- min_validation_rows_per_family: 2
- failed: False
- violations: []
