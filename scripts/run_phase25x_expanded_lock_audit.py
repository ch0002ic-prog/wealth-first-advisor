...
RUN_ROOT = ARTIFACT_ROOT / "main4_phase25x_runs"
...
VARIANTS = [
    Variant("v25x_pA", 0.0212, 1.1425, 3.05, 0.02145, -0.650, 0.650),
    Variant("v25x_n8", 0.0210, 1.1425, 3.00, 0.0214, -0.651, 0.651),
]
...
def main() -> int:
    ...
    out_detail = ARTIFACT_ROOT / "main4_phase25x_expanded_lock_detail.csv"
    out_scenario = ARTIFACT_ROOT / "main4_phase25x_expanded_lock_scenario_summary.csv"
    out_rank = ARTIFACT_ROOT / "main4_phase25x_expanded_lock_rank.csv"
    out_note = ARTIFACT_ROOT / "main4_phase25x_expanded_lock_note.json"
