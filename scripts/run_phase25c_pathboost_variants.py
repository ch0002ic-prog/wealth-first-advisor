...
RUN_ROOT = ARTIFACT_ROOT / "main4_phase25c_runs"
...
# Center around the prior best path-slack candidate (tailguard_med), then push stronger
# anti-tail-risk controls to lift path-bootstrap robust_min p05 under capped strict.
VARIANTS = [
    Variant(
        name="v25c_anchor_tailguard_med",
    ...
    Variant(
        name="v25c_tailhard_02",
        ridge_l2=0.024,
        action_smoothing=1.18,
        scale_turnover_penalty=4.5,
        no_trade_band=0.024,
    ...
    Variant(
        name="v25c_tailhard_03",
        ridge_l2=0.028,
        action_smoothing=1.22,
        scale_turnover_penalty=6.0,
        no_trade_band=0.026,
        min_signal_scale=-0.58,
        max_signal_scale=0.58,
        min_spy_weight=0.88,
        max_spy_weight=1.00,
    ),
    Variant(
        name="v25c_balance_recover",
        ridge_l2=0.020,
...
def main() -> int:
    ...
    policy_specs = [
        ...
        {"policy_id": "strict_looser_cap002", "min_step": 0.02, "configured_path": -0.006, "quantile": 0.5, "cap": 0.002},
    ...
    out_json = ARTIFACT_ROOT / "main4_phase25c_pathboost_variant_comparison.json"
    out_csv = ARTIFACT_ROOT / "main4_phase25c_pathboost_variant_comparison.csv"
    out_detail = ARTIFACT_ROOT / "main4_phase25c_pathboost_variant_detail.csv"
