...
export WEALTH_FIRST_MAIN4_TARGET_MODE
export WEALTH_FIRST_MAIN4_SCALE_TURNOVER_PENALTY
export WEALTH_FIRST_MAIN4_MIN_SIGNAL_SCALE
export WEALTH_FIRST_MAIN4_MAX_SIGNAL_SCALE
export WEALTH_FIRST_MAIN4_MIN_SPY_WEIGHT
export WEALTH_FIRST_MAIN4_MAX_SPY_WEIGHT
export WEALTH_FIRST_MAIN4_INITIAL_SPY_WEIGHT
