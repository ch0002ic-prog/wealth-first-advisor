...
RUN_ROOT = ARTIFACT_ROOT / "main4_phase25u_runs"
...
VARIANTS = [
    Variant("v25u_n8", 0.0210, 1.1425, 3.00, 0.0214, -0.651, 0.651),
    Variant("v25u_pA", 0.0212, 1.1425, 3.05, 0.02145, -0.650, 0.650),
]
...
def main() -> int:
    ...
    out_detail = ARTIFACT_ROOT / "main4_phase25u_reps_sweep_detail.csv"
    out_env = ARTIFACT_ROOT / "main4_phase25u_reps_sweep_env_summary.csv"
    out_agg = ARTIFACT_ROOT / "main4_phase25u_reps_sweep_aggregate.csv"
    out_note = ARTIFACT_ROOT / "main4_phase25u_reps_sweep_note.json"

    detail.sort_values(["variant", "path_bootstrap_reps", "envelope", "scenario", "seed"]).to_csv(out_detail, index=False)
