...
RUN_ROOT = ARTIFACT_ROOT / "main4_phase25d_runs"
...
VARIANTS = [
    # Reference from phase25c best near-feasible path-slack candidate.
    Variant(
        name="v25d_ref_tailhard01",
        ridge_l2=0.020,
    ...
    # Mildly tighter risk without large activity hit.
    Variant(
        name="v25d_tune_a",
        ridge_l2=0.021,
    ...
    Variant(
        ...
        no_trade_band=0.0235,
        min_signal_scale=-0.62,
        max_signal_scale=0.62,
    ),
    # Keep more activity while attempting better tail control.
    Variant(
        name="v25d_balance_activity",
        ridge_l2=0.021,
    ...
    # Bias against large downside actions.
    Variant(
        name="v25d_asym_downside",
        ridge_l2=0.022,
        action_smoothing=1.15,
...
def wealth_score(row: pd.Series) -> float:
    return (
        ...
        + 0.5 * float(row["robust_min_test_relative"])
...
def main() -> int:
    ...
    policy_specs = [
        ...
        {"policy_id": "cap003_step002", "min_step": 0.02, "configured_path": -0.006, "quantile": 0.5, "cap": 0.003},
        {"policy_id": "cap002_step0019", "min_step": 0.019, "configured_path": -0.006, "quantile": 0.5, "cap": 0.002},
    ]
    ...
    out_json = ARTIFACT_ROOT / "main4_phase25d_microtune_comparison.json"
    out_csv = ARTIFACT_ROOT / "main4_phase25d_microtune_comparison.csv"
    out_detail = ARTIFACT_ROOT / "main4_phase25d_microtune_detail.csv"
